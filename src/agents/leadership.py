...
class Leadership:
    ...
    async def run_research(self, state: SubAgentState, config: RunnableConfig):
        ...
        system_prompt = leadership_prompts.LEADERSHIP_SYSTEM_PROMPT

        user_prompt = leadership_prompts.build_leadership_user_prompt(
        ...
        validated_llm_response = LeadershipContextModels.model_validate(llm_response)
